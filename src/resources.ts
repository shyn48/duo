...
let stateInstance: DuoState | null = null;

export function setStateInstance(state: DuoState) {
  stateInstance = state;
}
 ...
 */
export async function getStateInstanceAutoLoad(): Promise<DuoState | null> {
...
export function getStateInstance(): DuoState | null {
