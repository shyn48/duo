 ...
 */
export async function readCodebaseKnowledge(stateDir: string): Promise<{ content: string; isNew: boolean }> {
 ...
 */
function insertInSection(content: string, sectionHeader: string, newContent: string): string {
